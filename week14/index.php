            ...
            <table class="table mt-3 text-center" id="table-emp">
                ...
                $sql = "SELECT * FROM employee";
                    ...
                    <tr id="row-<?php echo $row->id ?>">
                        ...
                        <td><button class="btn btn-info text-light btn-edit" style="width: 100px;" data-id="<?php echo $row->id ?>">Edit</button></td>
...
<!-- FORM. -->
    ...
    <div class="input-group mb-2">
        ...
        <input type="text" class="form-control" type="text" disabled id="id">
    </div>
    <div class="input-group mb-2">
    ...
    <button class="btn btn-success text-light w-100" id="btn-edit">Edit</button>  
    <button class="btn btn-danger text-light w-100" id="btn-cancel">Cancel</button>  
    </div>
<!-- FORM. -->
        </div>
    </div>
